...
/**
 * Updates the relationship of routine to performance_music_and_timing_statistic
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
class RoutinePerformanceMusicAndTimingStatisticUpdateAction extends AbstractAction {
