...
/**
 * Automatically generated JsonResponder for Reads the relationship of routine to performance_total_statistic
 * 
 * @author gossi
 */
class RoutinePerformanceTotalStatisticJsonResponder extends AbstractPayloadResponder {
