...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to performance_execution_statistic
 * 
 * @author gossi
 */
class StartgroupPerformanceExecutionStatisticJsonResponder extends AbstractPayloadResponder {
