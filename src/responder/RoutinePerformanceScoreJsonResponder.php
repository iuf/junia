...
/**
 * Automatically generated JsonResponder for Reads the relationship of routine to performance_score
 * 
 * @author gossi
 */
class RoutinePerformanceScoreJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->performanceScores($payload->getModel());
