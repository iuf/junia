...
/**
 * Automatically generated JsonResponder for Reads the relationship of routine to performance_music_and_timing_statistic
 * 
 * @author gossi
 */
class RoutinePerformanceMusicAndTimingStatisticJsonResponder extends AbstractPayloadResponder {
