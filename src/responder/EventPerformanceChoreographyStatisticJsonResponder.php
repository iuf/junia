...
/**
 * Automatically generated JsonResponder for Reads the relationship of event to performance_choreography_statistic
 * 
 * @author gossi
 */
class EventPerformanceChoreographyStatisticJsonResponder extends AbstractPayloadResponder {
