...
/**
 * Automatically generated JsonResponder for Reads the relationship of performance_statistic to startgroup
 * 
 * @author gossi
 */
class PerformanceStatisticStartgroupJsonResponder extends AbstractPayloadResponder {
