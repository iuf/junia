...
/**
 * Automatically generated JsonResponder for Reads the relationship of event to performance_music_and_timing_statistic
 * 
 * @author gossi
 */
class EventPerformanceMusicAndTimingStatisticJsonResponder extends AbstractPayloadResponder {
