...
/**
 * Automatically generated JsonResponder for Updates a score
 * 
 * @author gossi
 */
class ScoreUpdateJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$resource = $resource->fields($params->getFields([
			'score' => Score::getSerializer()->getFields(),
