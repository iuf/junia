...
/**
 * Automatically generated JsonResponder for Reads the relationship of performance_statistic to routine
 * 
 * @author gossi
 */
class PerformanceStatisticRoutineJsonResponder extends AbstractPayloadResponder {
