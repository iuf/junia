...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to performance_total_statistic
 * 
 * @author gossi
 */
class StartgroupPerformanceTotalStatisticJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->performanceTotalStatistic($payload->getModel());
