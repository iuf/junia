...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to event
 * 
 * @author gossi
 */
class StartgroupEventJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->event($payload->getModel());
