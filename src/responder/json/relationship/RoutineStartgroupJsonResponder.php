...
/**
 * Automatically generated JsonResponder for Reads the relationship of routine to startgroup
 * 
 * @author gossi
 */
class RoutineStartgroupJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->startgroup($payload->getModel());
