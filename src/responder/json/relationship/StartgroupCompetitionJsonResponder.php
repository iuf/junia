...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to competition
 * 
 * @author gossi
 */
class StartgroupCompetitionJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->competition($payload->getModel());
