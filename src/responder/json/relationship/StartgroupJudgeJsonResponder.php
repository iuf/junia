...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to judge
 * 
 * @author gossi
 */
class StartgroupJudgeJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->judges($payload->getModel());
