...
/**
 * Automatically generated JsonResponder for Reads the relationship of judge to performance_score
 * 
 * @author gossi
 */
class JudgePerformanceScoreJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->performanceScore($payload->getModel());
