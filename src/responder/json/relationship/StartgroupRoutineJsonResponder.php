...
/**
 * Automatically generated JsonResponder for Reads the relationship of startgroup to routine
 * 
 * @author gossi
 */
class StartgroupRoutineJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->routines($payload->getModel());
