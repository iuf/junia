...
/**
 * Automatically generated JsonResponder for Reads the relationship of performance_statistic to event
 * 
 * @author gossi
 */
class PerformanceStatisticEventJsonResponder extends AbstractPayloadResponder {
