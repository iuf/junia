...
/**
 * Automatically generated JsonResponder for Reads the relationship of event to performance_total_statistic
 * 
 * @author gossi
 */
class EventPerformanceTotalStatisticJsonResponder extends AbstractPayloadResponder {
