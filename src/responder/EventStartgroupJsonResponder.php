...
/**
 * Automatically generated JsonResponder for Reads the relationship of event to startgroup
 * 
 * @author gossi
 */
class EventStartgroupJsonResponder extends AbstractPayloadResponder {
