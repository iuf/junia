...
/**
 * Automatically generated JsonResponder for List all performance-statisticss
 * 
 * @author gossi
 */
class PerformanceStatisticsListJsonResponder extends AbstractPayloadResponder {
