...
/**
 * Automatically generated JsonResponder for Reads the relationship of performance_score to routine
 * 
 * @author gossi
 */
class PerformanceScoreRoutineJsonResponder extends AbstractPayloadResponder {
