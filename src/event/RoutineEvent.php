...
class RoutineEvent extends Event {
	...
	/**
	 */
	const POST_PERFORMANCE_STATISTICS_UPDATE = 'iuf.junia.routine.post_performance_statistics_update';
	...
	/**
	 */
	const PRE_PERFORMANCE_STATISTICS_UPDATE = 'iuf.junia.routine.pre_performance_statistics_update';
