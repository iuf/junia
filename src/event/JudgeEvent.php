...
class JudgeEvent extends Event {
	...
	/**
	 */
	const POST_PERFORMANCE_SCORE_UPDATE = 'iuf.junia.judge.post_performance_score_update';
	...
	/**
	 */
	const PRE_PERFORMANCE_SCORE_UPDATE = 'iuf.junia.judge.pre_performance_score_update';
