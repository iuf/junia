...
/**
 * Base class that represents a row from the 'kk_junia_competition' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Competition implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\iuf\\junia\\model\\Map\\CompetitionTableMap';
    ...
    /**
     * Initializes internal state of iuf\junia\model\Base\Competition object.
     */
    ...
    /**
     * Compares this with another <code>Competition</code> instance.  If
     * <code>obj</code> is an instance of <code>Competition</code>, delegates to
     * <code>equals(Competition)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Competition The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CompetitionTableMap::COL_ID] = true;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[CompetitionTableMap::COL_LABEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CompetitionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCompetitionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Competition::setDeleted()
     * @see Competition::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCompetitionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CompetitionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CompetitionTableMap::COL_ID)) {
    ...
    {
        $pos = CompetitionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Competition'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Competition'][$this->hashCode()] = true;
        $keys = CompetitionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\iuf\junia\model\Competition
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\iuf\junia\model\Competition The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompetitionTableMap::COL_ID)) {
            $criteria->add(CompetitionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CompetitionTableMap::COL_LABEL)) {
    ...
    {
        $criteria = ChildCompetitionQuery::create();
        $criteria->add(CompetitionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \iuf\junia\model\Competition (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \iuf\junia\model\Competition Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCompetition is new, it will return
    ...
    public function setStartgroups(Collection $startgroups, ConnectionInterface $con = null)
    {
        ...
        foreach ($startgroupsToDelete as $startgroupRemoved) {
            $startgroupRemoved->setCompetition(null);
        }
    ...
    protected function doAddStartgroup(ChildStartgroup $startgroup)
    {
        ...
        $startgroup->setCompetition($this);
    }
     ...
     * @return ObjectCollection|ChildStartgroup[] List of ChildStartgroup objects
     */
    public function getStartgroupsJoinEvent(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildStartgroupQuery::create(null, $criteria);
